...
if __name__ == '__main__':
    ...
    parser.add_argument('--infolder', default="Dataset_ICML_Final_Toy_V2")
    parser.add_argument('--outfolder', default="NRI_Toy")
    ...
    for typename in ['train', 'valid', 'test']:
        locname = os.path.join(args.outfolder, 'loc_'+typename+'_toy_final.npy')
        velname = os.path.join(args.outfolder, 'vel_'+typename+'_toy_final.npy')
        edgename = os.path.join(args.outfolder, 'edges_'+typename+'_toy_final.npy')
